...
import { PlayIcon, PauseIcon, SkipPrevIcon, SkipNextIcon } from './Icons.jsx';

// Compact bar shown above the tab nav whenever something is loaded.
export default function MiniPlayer() {
  const {
    current, isPlaying, togglePlay, setShowNowPlaying, currentTime, duration, playNext, playPrev,
  } = usePlayer();
    ...
    >
      <div className="flex items-center gap-1 pl-3 pr-2 py-2">
        ...
        <button
          ...
          className="grid place-items-center w-8 h-10 active:scale-90 transition text-white/90"
          aria-label="Previous"
        >
